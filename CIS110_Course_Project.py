...
while keepPlaying.lower() == "yes":
    ...
    print(f"Even though the journey is tough, {name} doesn't give up. After many hours of exploring the jungle, {adventurerName} finds an old looking paper on the ground which looks like a map")
